...
var (
	levelStrings = [...]string{"DBG", "INF", "WARN", "ERR", "FTL"}
)
...
// NewConsoleLogger creates a new logger with a "stdout" filter configured to send log messages at
...
// NewDefaultLogger creates a new logger with a "stdout" filter configured to send log messages at
// or above lvl to standard output.
...
// AddFilter add a new LogWriter to the Logger which will only log messages at lvl or higher.
// This function should not be called from multiple goroutines.
// Returns the logger for chaining.
func (l Logger) AddFilter(name string, lvl Level, writer LogWriter, categories ...string) Logger {
	var c string
	if len(categories) > 0 {
		c = categories[0]
	} else {
	...
	l[name] = &Filter{lvl, writer, c}
	return l
}

//Log Send a log message with manual level, source, and message.
func (l Logger) Log(lvl Level, source, message string) {
	skip := true
...
func (l Logger) Debug(arg0 interface{}, args ...interface{}) {
	l.Log(DEBUG, getSource(), getMessage(arg0, args...))
}

// Info logs a message at the info log level.
// See Debug for an explanation of the arguments.
func (l Logger) Info(arg0 interface{}, args ...interface{}) {
	l.Log(INFO, getSource(), getMessage(arg0, args...))
}
...
func (l Logger) Error(arg0 interface{}, args ...interface{}) error {
	msg := getMessage(arg0, args...)
	l.Log(ERROR, getSource(), msg)
	return errors.New(msg)
}

// Fatal logs a message at the fatal log level and returns the formatted error,
// See Warn for an explanation of the performance and Debug for an explanation
// of the parameters.
func (l Logger) Fatal(arg0 interface{}, args ...interface{}) error {
	msg := getMessage(arg0, args...)
	l.Log(FATAL, getSource(), msg)
	return errors.New(msg)
}

//getMessage returns formatted message
func getMessage(arg0 interface{}, args ...interface{}) string {
	var msg string
